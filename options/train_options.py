...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--batch_size', type=int, default=8, help='input batch size for the training set')
        ...
        parser.add_argument('--resume_train', type=bool, default=True, help='continue training: load the provided model')
        parser.add_argument('--load_checkpoint', type=str, default='./checkpoints/upsample_maxunpool2d_crop_cross_validate/selfmade/best_model_1.pth.tar',help='path to the checkpoint file in .pth.tar format')
        parser.add_argument('--num_epochs', type=int, default=150, help='number of epochs for one training session to run')
