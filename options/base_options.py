...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='upsample_maxunpool2d_crop_cross_validate', help='checkpoints of the current experiment are saved here')

        parser.add_argument('--dataroot',  default='./datasets/out', help='path to dataset in h5 format; please include the type of the dataset '
